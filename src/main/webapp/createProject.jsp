...
<body>
	...
	<div class="formSpacing">
		<label> Name : </label> <input type="text"
			value="<c:out value='${projectDTO.name}'/>" name="name"
			required="required"> <br>
	</div>
	<div class="formSpacing">
		<label> Start Date : </label> <input type="date"
			value="<c:out value='${projectDTO.startDate}'/>" name="startDate"
			required="required"> <br>
	</div>

	<div class="formSpacing">
		<label> End Date : </label> <input type="date"
			value="<c:out value='${projectDTO.endDate}'/>" name="endDate"
			required="required"><br>
	</div>
	<div class="formSpacing">
		<label> Status : </label> <select name="status"
			value="<c:out value='${projectDTO.status}'/>">
	...
	<div class="formSpacing">
		<label> Domain : </label> <input type="text"
			value="<c:out value='${projectDTO.domain}'/>" name="domain"
			required="required"><br>
	</div>
	<div class="back">
