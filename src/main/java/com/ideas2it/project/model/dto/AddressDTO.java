...
public class AddressDTO {
	...
	public String toString() {
		...
		display.append(" Address : ").append(" DoorNo : ").append(this.doorNo).append(" Landmark : ")
				.append(this.landMark).append(" Street : ").append(this.street).append(" City : ").append(this.city)
				.append(" Pincode : ").append(this.pincode).append("\n");
